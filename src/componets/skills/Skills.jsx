...
const Skills = () => {
    ...
    return (
        ...
        <section className={"pt-24"} id={"skills"}>
            ...
            <h2 data-aos="fade-up">Tools and Technologies</h2>
        ...
        <div className={"container w-full pb-2  experience__container2 "}>
            <div>
                ...
                <div className="md:flex md:justify-around lg:flex    justify-center  custom-grid">
                    ...
                    <article className="experience__details icon-center" data-aos="fade-down-right">
                        <div>
                            <img src={CSS} width={100} />
                            <h4  className={"text-center"}>Css</h4>
                        </div>
                    </article>
                    <article className="experience__details icon-center" data-aos="zoom-in-down">
                        <div>
                            <img src={js} width={100} />
                            <h4  className={"text-center"}>JavaScript</h4>
                        </div>
                    </article>
                    <article className="experience__details icon-center" data-aos="fade-down">
                        <div>
                            <img src={react} width={100} />
                            <h4  className={"text-center"}>React</h4>
                        </div>
                    </article>
                    <article className="experience__details icon-center" data-aos="fade-up">
                        <div>
                            <img src={next} width={90} />
                            <h4  className={"text-center"}>Nextjs</h4>
                        </div>
                    </article>
                    <article className="experience__details icon-center" data-aos="zoom-out-down">
                        <div>
                    ...
                    <article className="experience__details icon-center" data-aos="fade-down-left">
                        <div>
                            <img src={mui} width={100} />
                            <h4  className={"text-center"}>MUI</h4>
                        </div>
                    </article>
                    <article className="experience__details icon-center" data-aos="fade-left">
                        <div>
            ...
            <div>
                ...
                <div className="md:flex md:justify-around lg:flex  justify-between custom-grid">
                    ...
                    <article className="experience__details icon-center" data-aos="zoom-in">
                        <div>
                    ...
                    <article className="experience__details icon-center" data-aos="flip-right">
                        <div>
